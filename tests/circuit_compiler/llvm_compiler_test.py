...
from ck.circuit_compiler.llvm_compiler import Flavour
...
class TestLLVMCompilerFloat64Tmps(Fixture, CompilerCases):
...
class TestLLVMCompilerFloat64Stack(Fixture, CompilerCases):
...
class TestLLVMCompilerFloat64Funcs(Fixture, CompilerCases):
...
class TestLLVMCompilerDType(Fixture):
    ...
    def assert_constant(self, value, data_type: DataType) -> None:
        ...
        program = llvm_compiler.compile_circuit(const, data_type=data_type)
    ...
    def test_bool(self) -> None:
        ...
        program = llvm_compiler.compile_circuit(add, mul, data_type=DataType.BOOL)
    ...
    def test_xbool(self) -> None:
        ...
        program = llvm_compiler.compile_circuit(add, mul, data_type=DataType.XBOOL)
    ...
    def test_max_min(self) -> None:
        ...
        program = llvm_compiler.compile_circuit(add, mul, data_type=DataType.MAX_MIN)
    ...
    def test_max_mul(self) -> None:
        ...
        program = llvm_compiler.compile_circuit(add, mul, data_type=DataType.MAX_MUL)
    ...
    def test_max_sum(self) -> None:
        ...
        program = llvm_compiler.compile_circuit(add, mul, data_type=DataType.MAX_SUM)
    ...
    def test_custom_type_info(self) -> None:
        ...
        program = llvm_compiler.compile_circuit(add, mul, data_type=type_info)
    ...
    def test_const_vars(self) -> None:
        ...
        with TmpConst(cct) as tmp_const:
            ...
            program = llvm_compiler.compile_circuit(top)
